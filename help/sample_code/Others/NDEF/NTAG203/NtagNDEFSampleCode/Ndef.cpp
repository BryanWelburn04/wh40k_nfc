...
NdefMessage* Ndef::getNestedNdefMessage(int iIndex, vector<byte> uData)
{
    ...
    while(iIndex < uData.size())
    {
		...
		uDataTemp4.clear();
		for (iIdx = 0; iIdx < iPayloadLength; iIdx++) 
...
vector<byte> Ndef::encodeSmartPoster(CString sTitleLanguage, CString sTitle, URI_IDENTIFIER_CODE eUriPrefix, CString sUri, ACTION_RECORD eAction)
{
	/// <summary>
	...
	NdefRecordType* pNdefRecordType1;
	NdefRecordType* pNdefRecordType2;
	NdefRecordType* pNdefRecordType3;
	NdefRecordType* pNdefRecordType4;
	...
	uStatusByte |= (byte)sTitleLanguage.GetLength();

	pNdefRecordType1 = new NdefRecordType(NFC_FORM_WELL_KNOWN_TYPE, "T");
    ...
    // Encode Action
	////////////////////////////////////////////////////////////////////////
	pNdefRecordType2 = new NdefRecordType(NFC_FORM_WELL_KNOWN_TYPE, "act");
    if (eAction != NO_ACTION)
    {
        pNdefRecord = new NdefRecord(pNdefRecordType2);
        pNdefRecord->appendPayload((byte)eAction);
	...
	pNdefRecordType3 = new NdefRecordType(NFC_FORM_WELL_KNOWN_TYPE, "U");
    ...
    // Smart Poster Header
	////////////////////////////////////////////////////////////////////////
	pNdefRecordType4 = new NdefRecordType(NFC_FORM_WELL_KNOWN_TYPE, "Sp");
...
CString Ndef::getURIIdentifierCode(URI_IDENTIFIER_CODE eCode)
{
...
CString Ndef::getActionCode(ACTION_RECORD eCode)
{
    switch (eCode)
    {
