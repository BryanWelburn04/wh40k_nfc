...
public:
	...
	// Attributes
	int aM_DialogID[4];    // Array to hold the list of dialog boxes/tab pages for CTabCtrl
	int aM_nPageCount;     // Number of tab pages
	CDialog *aM_Dialog[4]; // CDialog Array Variable to hold the dialogs
	...
	void enableControls(bool bIsEnable);
	void resetFields() ;
	// Overrides
