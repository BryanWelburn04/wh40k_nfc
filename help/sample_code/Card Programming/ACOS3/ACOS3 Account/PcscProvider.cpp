...
// 
//  Description     : Container class implementation for PC/SC constants/enumerations
// 
...
// 
//=========================================================================================
// PcscProvider.cpp: implementation of the PcscProvider class.
//
//////////////////////////////////////////////////////////////////////
...
// Get the interpretation based from the smartcard function's return code
char* PcscProvider::getSCardErrorMsg(long errCode)
{
	static char errString[500];
	...
	switch (errCode)
	{
        ...
        default:
			sprintf (errString, "(%d) Undocumented error.", errCode);
            return errString;
	}
}
